...
export function normalizeCheckoutRequest(request) {
  ...
  if (typeof request.requestedByUserId !== "string" || !request.requestedByUserId) throw new TypeError("requestedByUserId is required.");
